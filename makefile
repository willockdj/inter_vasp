...
# for gnu compiler
CC = gcc
# for intel compiler, e.g. Thomas in UCL
#CC = icc
#
#
CFLAGS = -Wall
...
LFLAGS = -lm
#
COBJS = main.o read_input.o read_car.o read_cif.o read_pdb.o locate_string.o read_line.o \
        read_atom_data.o get_doub.o put_string.o copy_int.o int_to_string.o next_space.o \
        next_none_space.o get_int.o get_long_int.o \
        generate_neighbours.o standard_bond.o \
        ...
        move_molecule_with_flags.o move_atom.o inter_atom_vector.o \
        ...
        write_atom_data_gulp.o read_poscar.o read_potcar.o read_atom_data_vasp.o \
        read_atom_data_pdb.o \
        write_atom_data_poscar.o write_poscar.o write_onetep.o write_cif.o \
        sort_by_elem.o sort_by_miller.o read_outcar.o read_incar.o \
        cut_to_uscore.o cut_to_dot.o cut_to_digit.o latt_vecs_from_cart.o \
        ...
        move_selected_atoms.o interpolate_all_but_chosen.o write_pdb.o read_force_block.o \
        react_coord.o mol_dot.o mol_dist.o read_doscar.o write_doscsv.o \
        smear_dos.o read_xdatcar.o read_fdf.o read_onetep.o read_siesta_vectors.o \
        count_doscar.o reorientate_cell.o rotate_vector.o read_star_format.o write_csv.o \
        read_report.o define_cluster.o define_hemi.o pbc_interactions.o \
        set_binary.o detail_state.o fill_structure.o permutation.o set_defaults.o \
        set_up_groups.o count_oxygen_species.o find_oh_bonds.o block_print_int.o \
        read_punch.o
...
main.o             : main.c read_input.c read_outcar.c read_incar.c read_car.c read_cif.c \
                     cart_latt_vecs.c \
                     ...
                     read_potcar.c  read_fdf.c read_report.c count_oxygen_species.c \
...
read_cif.o         : read_cif.c get_doub.c \
                     put_string.c structures.h global_values.h
read_pdb.o         : read_pdb.c get_doub.c \
                     put_string.c structures.h global_values.h
...
read_atom_data_pdb.o : read_atom_data_pdb.c
get_doub.o         : get_doub.c get_long_int.c global_values.h
...
get_long_int.o     : get_long_int.c global_values.h
...
move_atom.o        : move_atom.c structures.h
...
inter_atom_vector.o : inter_atom_vector.c
...
write_cif.o : write_cif.c write_atom_data_poscar.c structures.h
write_onetep.o : write_onetep.c write_atom_data_poscar.c structures.h
sort_by_elem.o : sort_by_elem.c structures.h
sort_by_miller.o : sort_by_miller.c structures.h
cut_to_uscore.o : cut_to_uscore.c 
cut_to_dot.o : cut_to_dot.c 
cut_to_digit.o : cut_to_digit.c 
...
interpolate_all_but_chosen.o : interpolate_all_but_chosen.c
...
read_report.o      : read_report.c    
define_cluster.o   : define_cluster.c
define_hemi.o   : define_hemi.c 
pbc_interactions.o : pbc_interactions.c
vec_dot.o          : vec_dot.c
set_binary.o       : set_binary.c 
detail_state.o     : detail_state.c 
fill_structure.o   : fill_structure.c
permutation.o      : set_binary.c detail_state.c fill_structure.c permutation.c
set_defaults.o     : set_defaults.c
set_up_groups.o     : set_up_groups.c
count_oxygen_species.o : count_oxygen_species.c structures.h
block_print_int.o  : block_print_int.c
find_oh_bonds.o    : find_oh_bonds.c
read_punch.o : read_punch.c
